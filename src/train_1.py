...
W_conv1 = weight_variable([3, 3, 1, 30])  # 第一层卷积层
b_conv1 = bias_variable([30])  # 第一层卷积层的偏置量
# h_conv1 = tf.nn.relu(conv2d(x_image, W_conv1) + b_conv1)
h_conv1 = conv2d(x_image, W_conv1) + b_conv1

W_conv2 = weight_variable([3, 3, 30, 30])  # 第二次卷积层
...
W_conv3 = weight_variable([3, 3, 30, 30])  # 第三次卷积层
...
W_conv4 = weight_variable([3, 3, 30, 1])  # 第四次卷积层
