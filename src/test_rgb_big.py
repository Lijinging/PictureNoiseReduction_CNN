...
img_name = r'lena_big.png'
img_with_gauss_path = r'../show/pic_with_noise/' + img_name
pic_save_path = r'../show/after/'
noise_path = r'../show/noise/'

im = Image.open(img_with_gauss_path)
...
testImg(im, pic_save_path + img_name, noise_path + img_name)
